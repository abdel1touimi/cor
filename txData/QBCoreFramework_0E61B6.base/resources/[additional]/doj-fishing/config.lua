...
Config.sharkhammerPrice  = 100                                  -- Price of Hammerhead Sharks
...
Config.largeLootboxRewards = {                                  -- Rewards found in the treasure chest (keep price = 0)
    [1] = { name = "diamond_ring", price = 0, amount = 1, info = {}, type = "item", slot = 1, },
		[2] = { name = "diamond", price = 0, amount = 1, info = {}, type = "item", slot = 2, },
    [3] = { name = "goldchain", price = 0, amount = 1, info = {}, type = "item", slot = 3, },
    [4] = { name = "rolex", price = 0, amount = 1, info = {}, type = "item", slot = 4, },
